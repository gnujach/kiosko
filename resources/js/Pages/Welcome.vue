    ...
    <div class="dark:bg-gray-900 bg-dots-darker bg-gray-100 min-h-screen">
        <div class="w-full p-6 lg:p-8">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div
                    class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 my-auto"
                >
                    <Link
                        :href="route('tramites/')"
                    ...
                    >
                        <div class="w-full">
                            ...
                            <div
                                class="flex flex-row justify-evenly items-top w-full"
                            >
                                <h2
                                    class="mt-6 text-xl font-semibold text-gray-900 dark:text-white w-full"
                                >
